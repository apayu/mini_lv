...
Mix.install([{:plug_cowboy, "~> 2.5"}, {:jason, "~> 1.0"}, {:phoenix, "1.7.0"}, {:phoenix_live_view, "~> 0.19.0"}])
...
defmodule Example.EventExampleLive do
  ...
  def render(assigns) do
    ~H"""
    <button type="button" phx-click="show_word">Click</button>
    <div>
    <%= @word %>
    </div>
    """
  ...
  def handle_event("show_word", _params, socket) do
    {:noreply, assign(socket, :word, "Hello, World!")}
  end
end
